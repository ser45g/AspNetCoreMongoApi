...
{
    public class WeatherForecastUpdateRequestValidator: Validator<WeatherForecastUpdateRequest>
    {
        public WeatherForecastUpdateRequestValidator(IOptions<WeatherForecastValidationOptions> options) {
